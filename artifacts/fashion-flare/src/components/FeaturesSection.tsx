...
const features = [
  ...
  },
  {
    ...
    desc: "خطط محتوى شهرية بالذكاء الاصطناعي — رتّب منشوراتك وتتبّع تقويم المحتوى في مكان واحد",
    badge: null,
  },
  {
    icon: ShoppingBag,
  ...
  },
  {
    icon: BarChart3,
    title: "التحليلات",
    desc: "تتبع محتواك المولّد حسب المنصة والنوع — وشوف إيه الأكثر تفاعلاً.",
    badge: null,
  },
  {
    icon: Globe,
